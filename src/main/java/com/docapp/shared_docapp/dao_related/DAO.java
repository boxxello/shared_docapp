...
public interface DAO<T> {
    ...
    List<T> doRetrieveByConditionWithLimitAndOffsetAndOrder(String condition, int limit, int offset, String order) throws SQLException;
    ...
    void doUpdate(T object) throws SQLException;
